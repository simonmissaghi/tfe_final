                                ...
                                <div class="swiper-slide">
                                    <div class="wrapper-question">
                                        <div class="question">
                                            ...
                                            <ul class="answers">
                                                <li>
                                                    <input type="checkbox" class="networks-survey" id="networks_q3-1" name="q3[]" value="[1]" <?php if (isset($_SESSION['post-data']['q3'])){ if (in_array("[1]", $os)) {echo 'checked';}}?>>
                                                    <label class="checkbox networks-survey" for="networks_q3-1">pour passer le temps</label>
                                                </li>
                                                <li>
                                                    <input type="checkbox" class="networks-survey" id="networks_q3-2" name="q3[]" value="[2]" <?php if (isset($_SESSION['post-data']['q3'])){ if (in_array("[2]", $os)) {echo 'checked';}}?>>
                                                    <label class="checkbox networks-survey" for="networks_q3-2">pour rechercher une information</label>
                                                </li>
                                                <li>
                                                    <input type="checkbox" class="networks-survey" id="networks_q3-3" name="q3[]" value="[3]" <?php if (isset($_SESSION['post-data']['q3'])){ if (in_array("[3]", $os)) {echo 'checked';}}?>>
                                                    <label class="checkbox networks-survey" for="networks_q3-3">pour faire de la publicité pour mon profil/ma page</label>
                                                </li>
                                                <li>
                                                    <input type="checkbox" class="networks-survey" id="networks_q3-4" name="q3[]" value="[4]" <?php if (isset($_SESSION['post-data']['q3'])){ if (in_array("[4]", $os)) {echo 'checked';}}?>>
                                                    <label class="checkbox networks-survey" for="networks_q3-4">pour être au courant des dernières tendances</label>
                                                </li>
                                                <li>
                                                    <input type="checkbox" class="other__choice networks-survey" id="networks_q3-5" name="q3[]" value="" <?php if (isset($_SESSION['post-data']['q3'])){ if (in_array("[5]", $os)) {echo 'checked';}}?>>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="wrapper-question">
                                                <div class="question">
                                                    ...
                                                    <ul class="answers">
                                                        <li>
                                                            <input type="checkbox" class="networks-survey" id="networks_q5-1" name="q5[]" value="[1]" <?php if (isset($_SESSION['post-data']['q5'])){ if (in_array("[1]", $os2)) {echo 'checked';}}?>>
                                                            <label class="checkbox networks-survey" for="networks_q5-1">Des articles que je trouve pertinents</label>
                                                        </li>
                                                        <li>
                                                            <input type="checkbox" class="networks-survey" id="networks_q5-2" name="q5[]" value="[2]" <?php if (isset($_SESSION['post-data']['q5'])){ if (in_array("[2]", $os2)) {echo 'checked';}}?>>
                                                            <label class="checkbox networks-survey" for="networks_q5-2">Des images/vidéos de moi/ ma famille/ mes amis</label>
                                                        </li>
                                                        <li>
                                                            <input type="checkbox" class="networks-survey" id="networks_q5-3" name="q5[]" value="[3]" <?php if (isset($_SESSION['post-data']['q5'])){ if (in_array("[3]", $os2)) {echo 'checked';}}?>>
                                                            <label class="checkbox networks-survey" for="networks_q5-3">Des annonces à vendre</label>
                                                        </li>
                                                        <li>
                                                            <input type="checkbox" class="networks-survey" id="networks_q5-4" name="q5[]" value="[4]" <?php if (isset($_SESSION['post-data']['q5'])){ if (in_array("[4]", $os2)) {echo 'checked';}}?>>
                                                            <label class="checkbox networks-survey" for="networks_q5-4">Rien</label>
                                                        </li>
                                                        <li>
                                                            <input type="checkbox" class="other__choice networks-survey" id="networks_q5-5" name="q5[]" value="" <?php if (isset($_SESSION['post-data']['q5'])){ if (in_array("[5]", $os2)) {echo 'checked';}}?>>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="wrapper-question">
                                                    <div class="question">
                                                        ...
                                                        <ul class="answers">
                                                            <li>
                                                                <input type="checkbox" class="networks-survey" id="networks_q6-1" name="q6[]" value="[1]" <?php if (isset($_SESSION['post-data']['q6'])){ if (in_array("[1]", $os3)) {echo 'checked';}}?>>
                                                                <label class="checkbox networks-survey" for="networks_q6-1">Pour montrer ce que je fais</label>
                                                            </li>
                                                            <li>
                                                                <input type="checkbox" class="networks-survey" id="networks_q6-2" name="q6[]" value="[2]" <?php if (isset($_SESSION['post-data']['q6'])){ if (in_array("[2]", $os3)) {echo 'checked';}}?>>
                                                                <label class="checkbox networks-survey" for="networks_q6-2">Pour attirer plus de monde sur mes pages</label>
                                                            </li>
                                                            <li>
                                                                <input type="checkbox" class="networks-survey" id="networks_q6-3" name="q6[]" value="[3]" <?php if (isset($_SESSION['post-data']['q6'])){ if (in_array("[3]", $os3)) {echo 'checked';}}?>>
                                                                <label class="checkbox networks-survey" for="networks_q6-3">Pour gagner de l’argent</label>
                                                            </li>
                                                            <li>
                                                                <input type="checkbox" class="networks-survey" id="networks_q6-4" name="q6[]" value="[4]" <?php if (isset($_SESSION['post-data']['q6'])){ if (in_array("[4]", $os3)) {echo 'checked';}}?>>
                                                                <label class="checkbox networks-survey" for="networks_q6-4">Pour faire de la propagande sur un sujet</label>
                                                            </li>
                                                            <li>
                                                                <input type="checkbox" class="other__choice networks-survey" id="networks_q6-5" name="q6[]" value="" <?php if (isset($_SESSION['post-data']['q6'])){ if (in_array("[5]", $os3)) {echo 'checked';}}?>>
