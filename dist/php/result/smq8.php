...
$smq8_04 = $connection->prepare('SELECT
  (SELECT COUNT(*) FROM smartphones_survey WHERE gender = "1" AND q8 = "4") * 100 /
  (SELECT COUNT(*) FROM smartphones_survey WHERE gender = "1") AS pourcentage
  FROM smartphones_survey');
$smq8_04->execute();
...
$smq8_05 = $connection->prepare('SELECT
  (SELECT COUNT(*) FROM smartphones_survey WHERE gender = "1" AND q8 = "5") * 100 /
  (SELECT COUNT(*) FROM smartphones_survey WHERE gender = "1") AS pourcentage
  FROM smartphones_survey');
$smq8_05->execute();
...
$data_smq8 = array($pourcentagesmq8_01, $pourcentagesmq8_02, $pourcentagesmq8_03, $pourcentagesmq8_04, $pourcentagesmq8_05);
?>
