                            ...
                            <div class="swiper-wrapper">
                                    ...
                                    <div class="wrapper-question wrapper-question-intro">
                                        ...
                                        <ul class="answers answers-intro">
                                            <li class="answers--intro">
                                                <input type="radio" class="apps-survey" id="1" name="gender" value="1">
                                                <label class="genre apps-survey male" for="1">garçon</label>
                                            </li>
                                            <li class="answers--intro">
                                                <input type="radio" class="apps-survey" id="2" name="gender" value="2">
                                ...
                                <div class="swiper-slide">
                                    <div class="wrapper-question">
                                        ...
                                        <ul class="answers">
                                            <li>
                                                <input type="checkbox" class="apps-survey" id="app_q1-1" name="q1[]" value="[1]">
                                                <label class="checkbox apps-survey" for="app_q1-1">Sport</label>
                                            </li>
                                            <li>
                                                <input type="checkbox" class="apps-survey" id="app_q1-2" name="q1[]" value="[2]">
                                                <label class="checkbox apps-survey" for="app_q1-2">Musique</label>
                                            </li>
                                            <li>
                                                <input type="checkbox" class="apps-survey" id="app_q1-3" name="q1[]" value="[3]">
                                                <label class="checkbox apps-survey" for="app_q1-3">Journaux, infos</label>
                                            </li>
                                            <li>
                                                <input type="checkbox" class="apps-survey" id="app_q1-4" name="q1[]" value="[4]">
                                                <label class="checkbox apps-survey" for="app_q1-4">Streaming vidéos</label>
                                            </li>
                                            <li>
                                                <input type="checkbox" class="apps-survey" id="app_q1-5" name="q1[]" value="[5]">
                                                <label class="checkbox apps-survey" for="app_q1-5">Education</label>
                                            </li>
                                            <li>
                                                <input type="checkbox" class="apps-survey" id="app_q1-6" name="q1[]" value="[6]">
                                                <label class="checkbox apps-survey" for="app_q1-6">Réseaux sociaux, messageries</label>
                                            </li>
                                            <li>
                                                <input type="checkbox" class="apps-survey" id="app_q1-7" name="q1[]" value="[7]">
                                                <label class="checkbox apps-survey" for="app_q1-7">Jeux</label>
                                            </li>
                                            <li>
                                                <input type="checkbox" class="apps-survey" id="app_q1-8" name="q1[]" value="[8]">
                                                <label class="checkbox apps-survey" for="app_q1-8">Santé & fitness</label>
                                            </li>
                                            <li>
                                                <input type="checkbox" class="apps-survey" id="app_q1-9" name="q1[]" value="[9]">
                                                <label class="checkbox apps-survey" for="app_q1-9">Voyages & navigation</label>
                                            </li>
                                            <li>
                                                <input type="checkbox" class="apps-survey" id="app_q1-10" name="q1[]" value="[10]">
                                ...
                                <div class="swiper-slide">
                                    <div class="wrapper-question">
                                        <div class="question">
                                            ...
                                            <ul class="answers">
                                                <li>
                                                    <input type="radio" class="apps-survey" id="app_q2-1" name="q2" value="1">
                                                    <label class="apps-survey" for="app_q2-1">Extrêmement probable</label>
                                                </li>
                                                <li>
                                                    <input type="radio" class="apps-survey" id="app_q2-2" name="q2" value="2">
                                                    <label class="apps-survey" for="app_q2-2">Très probable</label>
                                                </li>
                                                <li>
                                                    <input type="radio" class="apps-survey" id="app_q2-3" name="q2" value="3">
                                                    <label class="apps-survey" for="app_q2-3">Relativement probable</label>
                                                </li>
                                                <li>
                                                    <input type="radio" class="apps-survey" id="app_q2-4" name="q2" value="4">
                                                    <label class="apps-survey" for="app_q2-4">Pas très probable</label>
                                                </li>
                                                <li>
                                                    <input type="radio" class="apps-survey" id="app_q2-5" name="q2" value="5">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="wrapper-question">
                                            <div class="question">
                                                ...
                                                <ul class="answers">
                                                    <li>
                                                        <input type="radio" class="apps-survey" id="app_q3-1" name="q3" value="1">
                                                        <label class="apps-survey" for="app_q3-1">Extrêmement important</label>
                                                    </li>
                                                    <li>
                                                        <input type="radio" class="apps-survey" id="app_q3-2" name="q3" value="2">
                                                        <label class="apps-survey" for="app_q3-2">Très important</label>
                                                    </li>
                                                    <li>
                                                        <input type="radio" class="apps-survey" id="app_q3-3" name="q3" value="3">
                                                        <label class="apps-survey" for="app_q3-3">Relativement important</label>
                                                    </li>
                                                    <li>
                                                        <input type="radio" class="apps-survey" id="app_q3-4" name="q3" value="4">
                                                        <label class="apps-survey" for="app_q3-4">Pas très important</label>
                                                    </li>
                                                    <li>
                                                        <input type="radio" class="apps-survey" id="app_q3-5" name="q3" value="5">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="wrapper-question">
                                                <div class="question">
                                                    ...
                                                    <ul class="answers">
                                                        <li>
                                                            <input type="radio" class="apps-survey" id="app_q4-1" name="q4" value="1">
                                                            <label class="apps-survey" for="app_q4-1">Extrêmement important</label>
                                                        </li>
                                                        <li>
                                                            <input type="radio" class="apps-survey" id="app_q4-2" name="q4" value="2">
                                                            <label class="apps-survey" for="app_q4-2">Très important</label>
                                                        </li>
                                                        <li>
                                                            <input type="radio" class="apps-survey" id="app_q4-3" name="q4" value="3">
                                                            <label class="apps-survey" for="app_q4-3">Relativement important</label>
                                                        </li>
                                                        <li>
                                                            <input type="radio" class="apps-survey" id="app_q4-4" name="q4" value="4">
                                                            <label class="apps-survey" for="app_q4-4">Pas très important</label>
                                                        </li>
                                                        <li>
                                                            <input type="radio" class="apps-survey" id="app_q4-5" name="q4" value="5">
